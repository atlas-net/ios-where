...
open class CustomTextField: UITextField {
	...
	open func configure() {
        ...
        textColor = Config.Colors.MainContentColorBlack
...
public class TextFieldFormItemCellModel {
	var title: String = ""
...
open class TextFieldFormItemCell: UITableViewCell, UITextFieldDelegate, CellHeightProvider {
	...
	public init(model: TextFieldFormItemCellModel) {
        ...
        backgroundColor = Config.Colors.TagFieldBackground
		titleLabel.backgroundColor = Config.Colors.TagFieldBackground
        titleLabel.textColor = Config.Colors.LightGreyTextColor
		//textField.backgroundColor = Config.Colors.TagViewBackground
