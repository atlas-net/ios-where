...
open class DOAlertAction : NSObject, NSCopying {
    ...
    var enabled: Bool {
        didSet {
            if (oldValue != enabled) {
                Foundation.NotificationCenter.default.post(name: Foundation.Notification.Name(rawValue: DOAlertActionEnabledDidChangeNotification), object: nil)
            }
        }
    }
...
open class DOAlertController : UIViewController, UITextFieldDelegate, UIViewControllerTransitioningDelegate {
    ...
    convenience public init(title: String?, message: String?, preferredStyle: DOAlertControllerStyle) {
        ...
        // NotificationCenter
        Foundation.NotificationCenter.default.addObserver(self, selector: #selector(DOAlertController.handleAlertActionEnabledDidChangeNotification(_:)), name: NSNotification.Name(rawValue: DOAlertActionEnabledDidChangeNotification), object: nil)
        Foundation.NotificationCenter.default.addObserver(self, selector: #selector(DOAlertController.handleKeyboardWillShowNotification(_:)), name: NSNotification.Name.UIKeyboardWillShow, object: nil)
        Foundation.NotificationCenter.default.addObserver(self, selector: #selector(DOAlertController.handleKeyboardWillHideNotification(_:)), name: NSNotification.Name.UIKeyboardWillHide, object: nil)
